...
#include<string.h>
#include<math.h>
float cinx[101],ciny[101],v[101][101],nowv[101][101],tv[101][101],ans;
int nleft,vis[101],n,m,pre[101],next[101],oo=999999999,list[101];
inline float dis(int x1, int y1, int x2, int y2)
{
	return int((float)sqrt((x1-x2)*(x1-x2)*1.0+(y1-y2)*(y1-y2)*1.0)*1000);
}
void dfs(int now)
{
	--nleft;
